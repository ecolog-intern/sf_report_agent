...
WHERE 
    ...
    AND scheduled_switching_date__c <= 2025-09-30
...
def run_bulk_query(instance_url: str, access_token: str, soql: str,
                   api_version: str, output_csv_path: str = None) -> list:
    """
...
if __name__ == "__main__":
    ...
    # クエリ実行（CSV出力パスを指定可能）
    results = run_bulk_query(instance_url, access_token, soql, api_version, output_csv_path=output_path)
